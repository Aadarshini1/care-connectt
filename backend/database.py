...
async def connect_db():
    ...
    print("========== CONNECT_DB START ==========")
    print("MongoDB URL:", repr(settings.MONGODB_URL))

    print("STEP 1: Creating AsyncIOMotorClient...")
    ...
    print(f"STEP 3: Selected database '{settings.DB_NAME}'")

    print("STEP 4: Pinging MongoDB...")
    await client.admin.command("ping")
    print("STEP 5: Ping successful")

    print("STEP 6: Creating indexes...")
    await create_indexes()
    print("STEP 7: Indexes created")

    print("========== CONNECT_DB COMPLETE ==========")
